...
/_/      /_/    \\__,_/ /_/ /_/ /_//_/  /_/|_|
    ...
    async def countdown_energy_wave(self, duration: int) -> None:
        """
        ...
        def render_frame(remaining: int, fill_mode: bool = False, fill_step: int = 0) -> "Text":
            ...
            hour, minute, second = remaining // 3600, (remaining % 3600) // 60, remaining % 60
            time_str = f"{hour:02}:{minute:02}:{second:02}"
            footer = f"\n\n[bold #AAAAAA]⏳ Time Left: [bold #00FFAA]{time_str}[/]"
